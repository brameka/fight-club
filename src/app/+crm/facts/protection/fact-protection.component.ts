...
@Component({
  selector: 'app-fact-protection',
  templateUrl: './fact-protection.component.html',
  styleUrls: ['./fact-protection.component.scss']
})
export class FactProtectionComponent implements AfterViewInit, OnInit  {
