...
@Component({
  selector: 'app-fact-preferences',
  templateUrl: './fact-preferences.component.html',
  styleUrls: ['./fact-preferences.component.scss']
})
export class FactPreferencesComponent implements AfterViewInit, OnInit  {
